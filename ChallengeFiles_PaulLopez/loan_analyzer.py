...
print(f"The average loan size is: {avg_loans}")
...
#    Else, the present value of the loan is less than the loan cost, then print a message that says 
# that the loan is too expensive and not worth the price.
# YOUR CODE HERE!

if present_value < loan_price:
        print("Looks like the loan is too expensive! Don't do the deal!")
else:
    print("The loan looks good you should do it!")
...
csv_output_path = Path("inexpensive_loan_file.csv")

# @TODO: Use the csv library and `csv.writer` to write the header row
# and each row of `loan.values()` from the `inexpensive_loans` list.
# YOUR CODE HERE!

print("Outputting results to csv file called inexpensive_loan_file.csv")    

#csvpath = Path("loan_analyzer_output_paulLopez.csv")
